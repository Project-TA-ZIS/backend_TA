      ...
      schemas: {
          ...
          allOf: [
            { $ref: "#/components/schemas/User" },
            {
              ...
              properties: {
                ...
                status_pernikahan: { type: "string", enum: ["menikah", "lajang", "cerai"], nullable: true },
                created_at: { type: "string", format: "date-time" },
                updated_at: { type: "string", format: "date-time", nullable: true },
                deleted_at: { type: "string", format: "date-time", nullable: true },
                deleted_status: { type: "integer", example: 0 },
        ...
        Mustahik: {
          ...
          properties: {
            ...
            status_pekerjaan: { type: "string", enum: ["tetap", "ga tetap"], nullable: true },
            pekerjaan: { type: "string", nullable: true },
            penghasilan: { type: "number", nullable: true },
            status_pernikahan: { type: "string", enum: ["menikah", "lajang", "cerai"], nullable: true },
            created_at: { type: "string", format: "date-time" },
            updated_at: { type: "string", format: "date-time", nullable: true },
            deleted_at: { type: "string", format: "date-time", nullable: true },
        ...
        PemasukanZIS: {
          ...
          properties: {
            ...
            kategori: { type: "string", example: "zakat mal" },
